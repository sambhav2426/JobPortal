...
public class JobSeekerApplyController {
    ...
    @Autowired
    public JobSeekerApplyController(JobPostActivityService jobPostActivityService, UsersService usersService, JobSeekerProfileService jobSeekeProfileService, JobSeekerProfileService jobSeekerProfileService, JobSeekerApplyService jobSeekerApplyService, JobSeekerSaveService jobSeekerSaveService, RecruiterProfileServices recruiterProfileServices, JobSeekerProfileService jobSeekerProfileService1) {
        this.jobPostActivityService = jobPostActivityService;
        this.usersService = usersService;
        this.jobSeekerApplyService = jobSeekerApplyService;
        this.jobSeekerSaveService = jobSeekerSaveService;
        this.recruiterProfileServices = recruiterProfileServices;
        this.jobSeekerProfileService = jobSeekerProfileService1;
    }
